...
.. image:: http://img.shields.io/pypi/v/colour.svg?style=flat :target:
https://pypi.python.org/pypi/colour/ :alt: Latest PyPI version

.. image:: http://img.shields.io/pypi/dm/colour.svg?style=flat :target:
https://pypi.python.org/pypi/colour/ :alt: Number of PyPI downloads

.. image::
http://img.shields.io/travis/vaab/colour/master.svg?style=flat :target:
https://travis-ci.org/vaab/colour/ :alt: Travis CI build status

The AH Plot library is a small and simple library that allows for
creation of consitent plots in python. This is optimized to be published
...
-  Lets say we want to create some data, plot it, and then use it in a
   latex file. Here's a quick line plot demo program:
...
-  This should generate a file named ``line_plot.pgf``, this can be
   included in a latex document such as
